...
class PE:
    ...
    def __parse__(self, fname, data, fast_load):
        ...
        if not lowest_section_offset or lowest_section_offset < offset:
            self.header = self.__data__[:int(offset)]
        else:
    ...
    def parse_sections(self, offset):
        ...
        """
         Deprecated code
         self.sections.sort(cmp=lambda a,b: (a.VirtualAddress > b.VirtualAddress) - (a.VirtualAddress < b.VirtualAddress))
        """
        sorted(self.sections, key=lambda  section: section.VirtualAddress) 
    ...
    def parse_version_information(self, version_struct):
        #print("11111111",type(version_struct))
        ...
        #print("start_offset=",start_offset,"version_struct.Size=",version_struct.Size)
        raw_data = self.__data__[ int(start_offset) : int(start_offset)+version_struct.Size ]
